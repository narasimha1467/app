 ...
 */
.controller('mmWeektimetableListCtrl', function($scope, $mmweektimetable, $mmAttendenceDelegate, $mmUtil) {
    ...
    function fetchWeektimetable(refresh) {
        return $mmWeektimetable.getUserWeektimetable(refresh).then(function(weektimetable) {
            ...
            angular.forEach(weektimetable, function(weektimetable) {
                weektimetable._handlers = $mmWeektimetableDelegate.getNavHandlersFor(weektimetable.id);
            });
            ...
            if (typeof error != 'undefined' && error !== '') {
                ...
                $mmUtil.showErrorModal('mm.weektimetable.errorloadcourses', true);
            }
        });
    }
