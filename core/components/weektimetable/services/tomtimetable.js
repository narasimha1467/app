 ...
 * @name $mmCourses
 */
.factory('$mmWeektimetable', function($q, $mmSite, $mmSitesManager, mmWeektimetableFrontPage) {

    var self = {},
        currentCourses = {};

    function storeWeektimetableInMemory(weektimetable) {
        angular.forEach(weektimetable, function(weektimetable) {
            currentAttendence[weektimetable.id] = weektimetable;
        });
    }
    ...
    self.getStoredCourse = function(id) {
        return currentWeektimetable[id];
    };
