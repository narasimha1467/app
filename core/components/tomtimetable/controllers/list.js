 ...
 */
.controller('mmTomtimetableListCtrl', function($scope, $mmtomtimetable, $mmAttendenceDelegate, $mmUtil) {
    ...
    function fetchTomtimetable(refresh) {
        return $mmTomtimetable.getUserTomtimetable(refresh).then(function(tomtimetable) {
            ...
            angular.forEach(tomtimetable, function(tomtimetable) {
                tomtimetable._handlers = $mmTomtimetableDelegate.getNavHandlersFor(timetable.id);
            });
            ...
            if (typeof error != 'undefined' && error !== '') {
                ...
                $mmUtil.showErrorModal('mm.tomtimetable.errorloadcourses', true);
            }
        });
    }
