 ...
 * @name $mmCourses
 */
.factory('$mmTomtimetable', function($q, $mmSite, $mmSitesManager, mmTomtimetableFrontPage) {

    var self = {},
        currentCourses = {};

    function storeTomtimetableInMemory(tomtimetable) {
        angular.forEach(tomtimetable, function(tomtimetable) {
            currentAttendence[tomtimetable.id] = tomtimetable;
        });
    }
