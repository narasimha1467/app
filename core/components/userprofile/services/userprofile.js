 ...
 * @name $mmCourses
 */
.factory('$mmUserprofile', function($q, $mmSite, $mmSitesManager, mmUserprofileFrontPage) {

    var self = {},
        currentCourses = {};

    function storeUserprofileInMemory(userprofile) {
        angular.forEach(userprofile, function(userprofile) {
            currentAttendence[userprofile.id] = userprofile;
        });
    }
