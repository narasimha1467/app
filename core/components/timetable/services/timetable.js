 ...
 * @name $mmCourses
 */
.factory('$mmTimetable', function($q, $mmSite, $mmSitesManager, mmTimetableFrontPage) {

    var self = {},
        currentCourses = {};

    function storeTimetableInMemory(timetable) {
        angular.forEach(timetable, function(timetable) {
            currentAttendence[timetable.id] = timetable;
        });
    }
