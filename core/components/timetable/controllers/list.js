 ...
 */
.controller('mmTimetableListCtrl', function($scope, $mmtimetable, $mmAttendenceDelegate, $mmUtil) {
    ...
    function fetchTimetable(refresh) {
        return $mmTimetable.getUserTimetable(refresh).then(function(timetable) {
            ...
            angular.forEach(timetable, function(timetable) {
                timetable._handlers = $mmTimetableDelegate.getNavHandlersFor(timetable.id);
            });
            ...
            if (typeof error != 'undefined' && error !== '') {
                ...
                $mmUtil.showErrorModal('mm.timetable.errorloadcourses', true);
            }
        });
    }
